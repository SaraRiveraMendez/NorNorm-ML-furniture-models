...
class Results(SimpleClass, DataExportMixin):
    ...
    """
    def __init__(self, orig_img: np.ndarray, path: str, names: Dict[int, str], boxes: Optional[torch.Tensor] = ..., masks: Optional[torch.Tensor] = ..., probs: Optional[torch.Tensor] = ..., keypoints: Optional[torch.Tensor] = ..., obb: Optional[torch.Tensor] = ..., speed: Optional[Dict[str, float]] = ...) -> None:
        """
    ...
    def update(self, boxes: Optional[torch.Tensor] = ..., masks: Optional[torch.Tensor] = ..., probs: Optional[torch.Tensor] = ..., obb: Optional[torch.Tensor] = ..., keypoints: Optional[torch.Tensor] = ...): # -> None:
        """
    ...
    def plot(self, conf: bool = ..., line_width: Optional[float] = ..., font_size: Optional[float] = ..., font: str = ..., pil: bool = ..., img: Optional[np.ndarray] = ..., im_gpu: Optional[torch.Tensor] = ..., kpt_radius: int = ..., kpt_line: bool = ..., labels: bool = ..., boxes: bool = ..., masks: bool = ..., probs: bool = ..., show: bool = ..., save: bool = ..., filename: Optional[str] = ..., color_mode: str = ..., txt_color: Tuple[int, int, int] = ...) -> np.ndarray:
        """
    ...
    def save(self, filename: Optional[str] = ..., *args, **kwargs) -> str:
        """
    ...
    def save_txt(self, txt_file: Union[str, Path], save_conf: bool = ...) -> str:
        """
    ...
    def save_crop(self, save_dir: Union[str, Path], file_name: Union[str, Path] = ...): # -> None:
        """
...
class Probs(BaseTensor):
    ...
    """
    def __init__(self, probs: Union[torch.Tensor, np.ndarray], orig_shape: Optional[Tuple[int, int]] = ...) -> None:
        """
