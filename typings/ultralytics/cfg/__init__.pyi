...
from ultralytics.utils import ASSETS, DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_PATH, IS_VSCODE, IterableSimpleNamespace, LOGGER, RANK, ROOT, RUNS_DIR, SETTINGS, SETTINGS_FILE, TESTS_RUNNING, YAML, checks, colorstr, deprecation_warn, vscode_msg
...
def get_cfg(cfg: Union[str, Path, Dict, SimpleNamespace] = ..., overrides: Dict = ...) -> SimpleNamespace:
    """
...
def check_cfg(cfg: Dict, hard: bool = ...) -> None:
    """
...
def get_save_dir(args: SimpleNamespace, name: str = ...) -> Path:
    """
...
def check_dict_alignment(base: Dict, custom: Dict, e: Exception = ...) -> None:
    """
