...
def linear_assignment(cost_matrix: np.ndarray, thresh: float, use_lap: bool = ...): # -> tuple[_Array[tuple[int, int], Any], tuple[int, ...], tuple[int, ...]] | tuple[list[list[Any]] | NDArray[Any], NDArray[intp] | list[Any], NDArray[intp] | list[Any]]:
    """
