...
class SAM(Model):
    ...
    def predict(self, source, stream: bool = ..., bboxes=..., points=..., labels=..., **kwargs): # -> List[Results]:
        """
    ...
    def __call__(self, source=..., stream: bool = ..., bboxes=..., points=..., labels=..., **kwargs): # -> List[Results]:
        """
        Perform segmentation prediction on the given image or video source.
    ...
    def info(self, detailed: bool = ..., verbose: bool = ...): # -> tuple[int, int, int, float | Any] | None:
        """
