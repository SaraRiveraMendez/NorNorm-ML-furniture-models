...
class DropPath(nn.Module):
    ...
    Examples:
        ...
        >>> output = drop_path(x)
    """
    def __init__(self, drop_prob: float = ..., scale_by_keep: bool = ...) -> None:
...
class MaskDownSampler(nn.Module):
    ...
    """
    def __init__(self, embed_dim: int = ..., kernel_size: int = ..., stride: int = ..., padding: int = ..., total_stride: int = ..., activation: Type[nn.Module] = ...) -> None:
...
class CXBlock(nn.Module):
    ...
    """
    def __init__(self, dim: int, kernel_size: int = ..., padding: int = ..., drop_path: float = ..., layer_scale_init_value: float = ..., use_dwconv: bool = ...) -> None:
        """
...
class Fuser(nn.Module):
    ...
    """
    def __init__(self, layer: nn.Module, num_layers: int, dim: Optional[int] = ..., input_projection: bool = ...) -> None:
        """
...
class RoPEAttention(Attention):
    ...
    """
    def __init__(self, *args, rope_theta: float = ..., rope_k_repeat: bool = ..., feat_sizes: Tuple[int, int] = ..., **kwargs) -> None:
        """Initialize RoPEAttention with rotary position encoding for enhanced positional awareness."""
        ...
    
    def forward(self, q: torch.Tensor, k: torch.Tensor, v: torch.Tensor, num_k_exclude_rope: int = ...) -> torch.Tensor:
...
class MultiScaleBlock(nn.Module):
    ...
    """
    def __init__(self, dim: int, dim_out: int, num_heads: int, mlp_ratio: float = ..., drop_path: float = ..., norm_layer: Union[nn.Module, str] = ..., q_stride: Tuple[int, int] = ..., act_layer: Type[nn.Module] = ..., window_size: int = ...) -> None:
