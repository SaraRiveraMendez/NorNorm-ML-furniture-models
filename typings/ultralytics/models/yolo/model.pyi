...
class YOLO(Model):
    ...
    """
    def __init__(self, model: Union[str, Path] = ..., task: Optional[str] = ..., verbose: bool = ...) -> None:
        """
...
class YOLOWorld(Model):
    ...
    """
    def __init__(self, model: Union[str, Path] = ..., verbose: bool = ...) -> None:
        """
...
class YOLOE(Model):
    ...
    def get_text_pe(self, texts): # -> Tensor | None:
    ...
    def val(self, validator=..., load_vp: bool = ..., refer_data: Optional[str] = ..., **kwargs):
        """
    ...
    def predict(self, source=..., stream: bool = ..., visual_prompts: Dict[str, List] = ..., refer_image=..., predictor=..., **kwargs): # -> List[Results]:
        """
